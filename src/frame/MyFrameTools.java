...
public class MyFrameTools {
    ...
    public static JLabel createJLabelWithFont(String text, Font f) {
        JLabel label = new JLabel(text);
        label.setFont(f);
        return label;
    }

    public static JPanel createJPanelWithBorder(String title) {
        JPanel panel = new JPanel();
        panel.setBorder(createMyTitledBorder(title));
        return panel;
    }
